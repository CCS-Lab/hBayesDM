...
PATH_TEMPLATE = Path(__file__) / 'templates'
PATH_OUTPUT = Path(__file__) / 'Python'
...
def main(json_file, verbose):
    ...
    with open(PATH_TEMPLATE / 'PY_DOCSTRING_TEMPLATE.txt', 'r') as f:
    ...
    with open(PATH_TEMPLATE / 'PY_CODE_TEMPLATE.txt', 'r') as f:
