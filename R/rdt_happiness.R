...
#'
#' @description
#' Hierarchical Bayesian Modeling of the Risky Decision Task (Rutledge et al., 2014, PNAS) with the following parameters: "w0" (baseline), "w1" (weight of certain rewards), "w2" (weight of expected values), "w3" (weight of reward prediction errors), "gam" (forgetting factor),and "sig" (standard deviation of error).
#'
#' \strong{MODEL:}
