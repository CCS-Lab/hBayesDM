#' @templateVar MODEL_FUNCTION wcs_sql_rp1f
...
#' @templateVar MODEL_NAME Sequential Learning Model (RP1F)
...
#' @templateVar PARAMETERS "r" (reward sensitivity), "p" (punishment sensitivity), "f" (attentional focusing)
