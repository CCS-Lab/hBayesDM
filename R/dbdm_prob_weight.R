...
#' @templateVar PARAMETERS "tau" (probability weight function), "rho" (subject utility fucntion), "lambda" (loss aversion parameter), and "beta" (inverse softmax temperature)
...
#' @templateVar DETAILS_DATA_8 \item{"choice"}{If option1 was taken, choice == 1, else choice == 2}
#'
