#' @templateVar MODEL_FUNCTION aversivelearning_gamma
#' @templateVar CONTRIBUTOR 
#' @templateVar TASK_NAME Aversive Learning Task
#' @templateVar TASK_CODE aversivelearning
...
aversivelearning_gamma <- hBayesDM_model(
  ...
  regressors      = NULL,
  postpreds       = c("y_pred"),
  preprocess_func = aversivelearning_preprocess_func)
