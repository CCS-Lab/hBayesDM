#' @templateVar MODEL_FUNCTION ra_noLA
#' @templateVar CONTRIBUTOR 
#' @templateVar TASK_NAME Risk Aversion Task
#' @templateVar TASK_CODE ra
#' @templateVar TASK_CITE 
#' @templateVar MODEL_NAME Prospect Theory, without loss aversion (LA) parameter
#' @templateVar MODEL_CODE noLA
#' @templateVar MODEL_CITE (Sokol-Hessner et al., 2009)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "gain", "loss", "cert", "gamble"
#' @templateVar PARAMETERS \code{rho} (risk aversion), \code{tau} (inverse temperature)
