#' @templateVar MODEL_FUNCTION prl_fictitious_cnc_multipleB
...
#' @templateVar MODEL_NAME Fictitious Update Model, with chosen/not-chosen learning rates
#' @templateVar MODEL_CODE fictitious_cnc
...
#' @templateVar PARAMETERS \code{eta_c} (learning rate for chosen option), \code{eta_nc} (learning rate for non-chosen option), \code{alpha} (indecision point), \code{beta} (inverse temperature)
...
prl_fictitious_cnc_multipleB <- hBayesDM_model(
  task_name       = "prl",
