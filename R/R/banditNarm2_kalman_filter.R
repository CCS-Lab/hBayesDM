#' @templateVar MODEL_FUNCTION banditNarm2_kalman_filter
...
#' @templateVar TASK_CODE banditNarm2
...
banditNarm2_kalman_filter <- hBayesDM_model(
  ...
  regressors      = NULL,
  postpreds       = c("y_pred"),
  preprocess_func = banditNarm2_preprocess_func)
