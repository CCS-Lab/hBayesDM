...
#' @templateVar MODEL_NAME Fictitious Update Model, with separate learning rates for positive and negative prediction error (PE)
#' @templateVar MODEL_CODE fictitious_rp
#' @templateVar MODEL_CITE (Glascher et al., 2009; Ouden et al., 2013)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "choice", "outcome"
#' @templateVar PARAMETERS \code{eta_pos} (learning rate, +PE), \code{eta_neg} (learning rate, -PE), \code{alpha} (indecision point), \code{beta} (inverse temperature)
