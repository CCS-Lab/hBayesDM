...
hgf_ibrb_multipleB_preprocess_func <- function(raw_data, general_info,
                                               L, input_first, mu0_lower, mu0_upper, sigma0,
                                               kappa_lower, kappa_upper,
                                               omega_lower, omega_upper,
                                               zeta_lower, zeta_upper) {
...
ehgf_ibrb_vds_preprocess_func <- function(raw_data, general_info,
                                     L, input_first, mu0_lower, mu0_upper, sigma0,
                                     kappa_lower, kappa_upper,
                                     omega_lower, omega_upper) {
  # Extract from raw_data
...
ehgf_ibrb_vds_multipleB_preprocess_func <- function(raw_data, general_info,
                                               L, input_first, mu0_lower, mu0_upper, sigma0,
                                               kappa_lower, kappa_upper,
                                               omega_lower, omega_upper) {
  # Extract from raw_data
