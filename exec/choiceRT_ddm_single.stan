# based on codes by Guido Biele, Joseph Burling, Andrew Ellis, and potentially others @ Stan mailing lists
data {
  ...
  #int su; // group sizes upper boundary responses
  #int sl; // group sizes lower boundary responses
