...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_prl_fictitious");
    reader.add_event(187, 172, "end", "model_prl_fictitious");
    return reader;
}
...
typedef model_prl_fictitious_namespace::model_prl_fictitious stan_model;
