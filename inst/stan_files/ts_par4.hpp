...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_ts_par4");
    reader.add_event(218, 203, "end", "model_ts_par4");
    return reader;
}
...
typedef model_ts_par4_namespace::model_ts_par4 stan_model;
