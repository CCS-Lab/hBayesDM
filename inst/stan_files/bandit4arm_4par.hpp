...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_bandit4arm_4par");
    reader.add_event(190, 175, "end", "model_bandit4arm_4par");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsubj,i,"Tsubj",1); ++t) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (stan::model::rvalue(log_lik, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "log_lik") + categorical_logit_log(get_base1(get_base1(choice,i,"choice",1),t,"choice",2),Qsum)), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 164;
                    stan::model::assign(y_pred, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list())), 
                                categorical_rng(softmax(Qsum), base_rng__), 
                                "assigning variable y_pred");
...
typedef model_bandit4arm_4par_namespace::model_bandit4arm_4par stan_model;
