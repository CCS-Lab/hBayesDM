...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_bandit2arm_delta");
    reader.add_event(123, 108, "end", "model_bandit2arm_delta");
    return reader;
}
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsubj,i,"Tsubj",1); ++t) {
                    ...
                    stan::model::assign(ev, 
                                ...
                                (stan::model::rvalue(ev, stan::model::cons_list(stan::model::index_uni(get_base1(get_base1(choice,i,"choice",1),t,"choice",2)), stan::model::nil_index_list()), "ev") + (get_base1(A,i,"A",1) * PE)), 
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsubj,i,"Tsubj",1); ++t) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (stan::model::rvalue(log_lik, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "log_lik") + categorical_logit_log(get_base1(get_base1(choice,i,"choice",1),t,"choice",2),multiply(get_base1(tau,i,"tau",1),ev))), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 111;
                    stan::model::assign(y_pred, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list())), 
                                categorical_rng(softmax(multiply(get_base1(tau,i,"tau",1),ev)), base_rng__), 
                                "assigning variable y_pred");
...
typedef model_bandit2arm_delta_namespace::model_bandit2arm_delta stan_model;
