...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_cra_linear");
    reader.add_event(144, 129, "end", "model_cra_linear");
    return reader;
}
...
typedef model_cra_linear_namespace::model_cra_linear stan_model;
