...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_igt_pvl_decay");
    reader.add_event(148, 133, "end", "model_igt_pvl_decay");
    return reader;
}
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsubj,i,"Tsubj",1); ++t) {
                    ...
                    stan::model::assign(ev, 
                                ...
                                (stan::model::rvalue(ev, stan::model::cons_list(stan::model::index_uni(get_base1(get_base1(choice,i,"choice",1),t,"choice",2)), stan::model::nil_index_list()), "ev") + curUtil), 
...
typedef model_igt_pvl_decay_namespace::model_igt_pvl_decay stan_model;
