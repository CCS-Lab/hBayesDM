...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_igt_orl");
    reader.add_event(221, 206, "end", "model_igt_orl");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaF_pr;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaP_pr;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaF(static_cast<Eigen::VectorXd::Index>(N));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  betaP(static_cast<Eigen::VectorXd::Index>(N));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  ef(static_cast<Eigen::VectorXd::Index>(4));
                ...
                Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  PEfreq_fic(static_cast<Eigen::VectorXd::Index>(4));
                ...
                Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  PEval_fic(static_cast<Eigen::VectorXd::Index>(4));
                ...
                for (int t = 1; t <= get_base1(Tsubj,i,"Tsubj",1); ++t) {
                    ...
                    if (as_bool(logical_gte(get_base1(get_base1(outcome,i,"outcome",1),t,"outcome",2),0))) {
                        ...
                        stan::model::assign(ef, 
                                    stan::model::cons_list(stan::model::index_uni(get_base1(get_base1(choice,i,"choice",1),t,"choice",2)), stan::model::nil_index_list()), 
                                    (efChosen + (get_base1(Apun,i,"Apun",1) * PEfreq)), 
                                    "assigning variable ef");
                        current_statement_begin__ = 116;
                        stan::model::assign(ev, 
                                    stan::model::cons_list(stan::model::index_uni(get_base1(get_base1(choice,i,"choice",1),t,"choice",2)), stan::model::nil_index_list()), 
                                    (evChosen + (get_base1(Apun,i,"Apun",1) * PEval)), 
                                    "assigning variable ev");
                    }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int t = 1; t <= get_base1(Tsubj,i,"Tsubj",1); ++t) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (stan::model::rvalue(log_lik, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "log_lik") + categorical_logit_log(get_base1(get_base1(choice,i,"choice",1),t,"choice",2),util)), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 185;
                    stan::model::assign(y_pred, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list())), 
                                categorical_rng(softmax(util), base_rng__), 
                                "assigning variable y_pred");
...
typedef model_igt_orl_namespace::model_igt_orl stan_model;
