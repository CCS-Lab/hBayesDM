...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(14, 1, "restart", "model_prl_rp_multipleB");
    reader.add_event(175, 160, "end", "model_prl_rp_multipleB");
    return reader;
}
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int bIdx = 1; bIdx <= get_base1(Bsubj,i,"Bsubj",1); ++bIdx) {
                    ...
                    for (int t = 1; t <= get_base1(get_base1(Tsubj,i,"Tsubj",1),bIdx,"Tsubj",2); ++t) {
                        ...
                        stan::model::assign(log_lik, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(log_lik, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "log_lik") + categorical_logit_log(get_base1(get_base1(get_base1(choice,i,"choice",1),bIdx,"choice",2),t,"choice",3),multiply(ev,get_base1(beta,i,"beta",1)))), 
                                    "assigning variable log_lik");
...
typedef model_prl_rp_multipleB_namespace::model_prl_rp_multipleB stan_model;
