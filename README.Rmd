**(As of 1/19/2017)** Some functions (e.g., plot(hBayesDM_object), printFit(hBayesDM_object)) don't work but it will be fixed within a day. Thanks for your patience. <br><br>
