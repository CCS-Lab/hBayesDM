...
csl: apa-short-authors.csl
bibliography: hBayesDM_bib.bib
---
<br>
...
Table: As of hBayesDM v0.2.3.1 (`r format(Sys.time(), '%B %d, %Y')`) <!-- (March 21, 2016) -->
library(pander)
print(ascii(head(iris[,1:4])), style = 'rmarkdown')
...
```{r echo=FALSE}
load("~/Dropbox/output/m4/all_gng_m4data.RData")
```
<br>
