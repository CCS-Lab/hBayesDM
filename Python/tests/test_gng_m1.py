...
def test_gng_models():
    ...
    fit2 = gng_m2(example=True, niter=200, nwarmup=100, nchain=1, ncore=1)
    fit3 = gng_m3(example=True, niter=200, nwarmup=100, nchain=1, ncore=1)
    fit4 = gng_m4(example=True, niter=200, nwarmup=100, nchain=1, ncore=1)
