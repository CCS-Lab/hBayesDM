...
def bart_ewmv(
    ...
    using Exponential-Weight Mean-Variance Model [Park2020]_ with the following parameters:
    "phi" (prior belief of burst), "eta" (updating exponent), "rho" (risk preference), "tau" (inverse temperature), "lambda" (loss aversion).
