...
__all__ = ['prl_rp_multipleB']


class PrlRpMultipleb(TaskModel):
...
def prl_rp_multipleB(
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- prl_rp_multipleB(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
