...
from hbayesdm.preprocess_funcs import task2AFC_preprocess_func

__all__ = ['task2AFC_sdt']


class Task2AfcSdt(TaskModel):
    ...
    _preprocess_func = task2AFC_preprocess_func
...
def task2AFC_sdt(
    ...
    Hierarchical Bayesian Modeling of the 2-alternative forced choice task 
    ...
    .. codeauthor:: Heesun Park <heesunpark26@gmail.com>
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the 2-alternative forced choice task, there should be 3 columns of data
    with the labels "subjID", "stimulus", "response". It is not necessary for the columns to be
    ...
    data
        ...
        Data columns should be labeled as: "subjID", "stimulus", "response".
    niter
