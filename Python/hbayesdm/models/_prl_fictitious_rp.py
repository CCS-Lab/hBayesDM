...
__all__ = ['prl_fictitious_rp']


class PrlFictitiousRp(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='prl',
            model_name='fictitious_rp',
            model_type='',
            data_columns=(
                'subjID',
                'choice',
...
def prl_fictitious_rp(
    ...
    using Fictitious Update Model, with separate learning rates for positive and negative prediction error (PE) [Glascher2009]_, [Ouden2013]_ with the following parameters:
    "eta_pos" (learning rate, +PE), "eta_neg" (learning rate, -PE), "alpha" (indecision point), "beta" (inverse temperature).
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- prl_fictitious_rp(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
