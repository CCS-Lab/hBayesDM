...
from hbayesdm.preprocess_funcs import choiceRT_preprocess_func

__all__ = ['choiceRT_ddm']


class ChoicertDdm(TaskModel):
    ...
    _preprocess_func = choiceRT_preprocess_func
...
def choiceRT_ddm(
    ...
    Hierarchical Bayesian Modeling of the Choice Reaction Time Task 
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- choiceRT_ddm(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
