...
from hbayesdm.preprocess_funcs import aversivelearning_preprocess_func

__all__ = ['aversivelearning_gamma']


class AversivelearningGamma(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='aversivelearning',
            model_name='gamma',
            model_type='',
            data_columns=(
                'subjID',
    ...
    _preprocess_func = aversivelearning_preprocess_func


def aversivelearning_gamma(
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the Aversive Learning Task, there should be 5 columns of data
    with the labels "subjID", "choice", "outcome", "bluePunish", "orangePunish". It is not necessary for the columns to be
    ...
    data
        ...
        Data columns should be labeled as: "subjID", "choice", "outcome", "bluePunish", "orangePunish".
    niter
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('aversivelearning_gamma').
    ...
    .. code:: python
        ...
        output = aversivelearning_gamma(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
