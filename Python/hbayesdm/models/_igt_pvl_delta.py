...
__all__ = ['igt_pvl_delta']


class IgtPvlDelta(TaskModel):
...
def igt_pvl_delta(
    ...
    using Prospect Valence Learning (PVL) Delta [Ahn2008]_ with the following parameters:
    "A" (learning rate), "alpha" (outcome sensitivity), "cons" (response consistency), "lambda" (loss aversion).
