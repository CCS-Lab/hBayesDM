...
def ug_delta(
    ...
    using Rescorla-Wagner (Delta) Model [Gu2015]_ with the following parameters:
    "alpha" (envy), "tau" (inverse temperature), "ep" (norm adaptation rate).
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- ug_delta(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
