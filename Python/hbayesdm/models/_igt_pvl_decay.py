...
__all__ = ['igt_pvl_decay']


class IgtPvlDecay(TaskModel):
...
def igt_pvl_decay(
    ...
    using Prospect Valence Learning (PVL) Decay-RI [Ahn2014]_ with the following parameters:
    "A" (decay rate), "alpha" (outcome sensitivity), "cons" (response consistency), "lambda" (loss aversion).
    ...
    .. [Ahn2014] Ahn, W.-Y., Vasilev, G., Lee, S.-H., Busemeyer, J. R., Kruschke, J. K., Bechara, A., & Vassileva, J. (2014). Decision-making in stimulant and opiate addicts in protracted abstinence: evidence from computational modeling with pure users. Frontiers in Psychology, 5, 1376. https://doi.org/10.3389/fpsyg.2014.00849
