...
def gng_m4(
    ...
    using RW (rew/pun) + noise + bias + pi [Cavanagh2013]_ with the following parameters:
    "xi" (noise), "ep" (learning rate), "b" (action bias), "pi" (Pavlovian bias), "rhoRew" (reward sensitivity), "rhoPun" (punishment sensitivity).
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- gng_m4(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
