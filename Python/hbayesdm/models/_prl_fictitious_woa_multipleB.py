...
__all__ = ['prl_fictitious_woa_multipleB']


class PrlFictitiousWoaMultipleb(TaskModel):
...
def prl_fictitious_woa_multipleB(
    ...
    using Fictitious Update Model, without alpha (indecision point) [Glascher2009]_ with the following parameters:
    "eta" (learning rate), "beta" (inverse temperature).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('prl_fictitious_woa_multipleB').
    ...
    .. code:: python
        ...
        output = prl_fictitious_woa_multipleB(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return PrlFictitiousWoaMultipleb(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,
