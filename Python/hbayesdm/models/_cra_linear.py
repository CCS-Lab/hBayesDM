...
def cra_linear(
    ...
    using Linear Subjective Value Model [Levy2010]_ with the following parameters:
    "alpha" (risk attitude), "beta" (ambiguity attitude), "gamma" (inverse temperature).

    

    
    .. [Levy2010] Levy, I., Snell, J., Nelson, A. J., Rustichini, A., & Glimcher, P. W. (2010). Neural representation of subjective value under risk and ambiguity. Journal of Neurophysiology, 103(2), 1036-1047.
