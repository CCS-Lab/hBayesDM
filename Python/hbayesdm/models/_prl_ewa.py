...
def prl_ewa(
    ...
    using Experience-Weighted Attraction Model [Ouden2013]_ with the following parameters:
    "phi" (1 - learning rate), "rho" (experience decay factor), "beta" (inverse temperature).
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    model_regressor
        Whether to export model-based regressors. For this model they are: "ev_c", "ev_nc", "ew_c", "ew_nc".
    vb
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- prl_ewa(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
