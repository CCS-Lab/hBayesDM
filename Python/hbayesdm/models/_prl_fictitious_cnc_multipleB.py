...
__all__ = ['prl_fictitious_cnc_multipleB']


class PrlFictitiousCncMultipleb(TaskModel):
...
def prl_fictitious_cnc_multipleB(
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('prl_fictitious_cnc_multipleB').
    ...
    .. code:: python
        ...
        output = prl_fictitious_cnc_multipleB(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return PrlFictitiousCncMultipleb(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,
