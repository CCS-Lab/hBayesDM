...
__all__ = ['aversivelearning_delta']


class AversivelearningDelta(TaskModel):
...
def aversivelearning_delta(
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('aversivelearning_delta').
    ...
    .. code:: python
        ...
        output = aversivelearning_delta(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
