...
__all__ = ['prl_fictitious_woa']


class PrlFictitiousWoa(TaskModel):
...
def prl_fictitious_woa(
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- prl_fictitious_woa(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
