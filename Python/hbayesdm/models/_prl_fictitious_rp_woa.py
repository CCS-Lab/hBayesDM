...
__all__ = ['prl_fictitious_rp_woa']


class PrlFictitiousRpWoa(TaskModel):
...
def prl_fictitious_rp_woa(
    ...
    using Fictitious Update Model, with separate learning rates for positive and negative prediction error (PE), without alpha (indecision point) [Glascher2009]_, [Ouden2013]_ with the following parameters:
    "eta_pos" (learning rate, +PE), "eta_neg" (learning rate, -PE), "beta" (inverse temperature).
