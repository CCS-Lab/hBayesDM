...
from hbayesdm.preprocess_funcs import dd_preprocess_func

__all__ = ['dd_cs']


class DdCs(TaskModel):
    ...
    _preprocess_func = dd_preprocess_func
...
def dd_cs(
    ...
    Hierarchical Bayesian Modeling of the Delay Discounting Task 
    using Constant-Sensitivity (CS) Model [Ebert2007]_ with the following parameters:
    "r" (exponential discounting rate), "s" (impatience), "beta" (inverse temperature).
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- dd_cs(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
