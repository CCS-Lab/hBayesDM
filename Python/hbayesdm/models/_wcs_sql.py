...
from hbayesdm.preprocess_funcs import wcs_preprocess_func

__all__ = ['wcs_sql']


class WcsSql(TaskModel):
    ...
    _preprocess_func = wcs_preprocess_func
...
def wcs_sql(
    ...
    Hierarchical Bayesian Modeling of the Wisconsin Card Sorting Task 
    using Sequential Learning Model [Bishara2010]_ with the following parameters:
    "r" (reward sensitivity), "p" (punishment sensitivity), "d" (decision consistency or inverse temperature).

    

    
    .. [Bishara2010] Bishara, A. J., Kruschke, J. K., Stout, J. C., Bechara, A., McCabe, D. P., & Busemeyer, J. R. (2010). Sequential learning models for the Wisconsin card sort task: Assessing processes in substance dependent individuals. Journal of Mathematical Psychology, 54(1), 5-13.

    .. codeauthor:: Dayeong Min <mindy2801@snu.ac.kr>
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the Wisconsin Card Sorting Task, there should be 3 columns of data
