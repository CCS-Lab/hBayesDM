...
__all__ = ['bandit4arm_singleA_lapse']


class Bandit4ArmSingleaLapse(TaskModel):
...
def bandit4arm_singleA_lapse(
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- bandit4arm_singleA_lapse(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
