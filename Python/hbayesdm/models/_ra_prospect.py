...
def ra_prospect(
    ...
    using Prospect Theory [Sokol-Hessner2009]_ with the following parameters:
    "rho" (risk aversion), "lambda" (loss aversion), "tau" (inverse temperature).
    ...
    **additional_args
    ...
    .. code:: python
        ...
        output <- ra_prospect(example=True, niter=2000, nwarmup=1000, nchain=4, ncore=4)
