...
from hbayesdm.preprocess_funcs import bandit4arm2_preprocess_func

__all__ = ['bandit4arm2_kalman_filter']


class Bandit4Arm2KalmanFilter(TaskModel):
    ...
    _preprocess_func = bandit4arm2_preprocess_func
...
def bandit4arm2_kalman_filter(
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the 4-Armed Bandit Task (modified), there should be 3 columns of data
