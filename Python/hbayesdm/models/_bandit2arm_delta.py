...
from hbayesdm.preprocess_funcs import bandit2arm_preprocess_func

__all__ = ['bandit2arm_delta']


class Bandit2ArmDelta(TaskModel):
    ...
    _preprocess_func = bandit2arm_preprocess_func
...
def bandit2arm_delta(
    ...
    Hierarchical Bayesian Modeling of the 2-Armed Bandit Task [Erev2010]_, [Hertwig2004]_
    using Rescorla-Wagner (Delta) Model  with the following parameters:
    "A" (learning rate), "tau" (inverse temperature).

    

    .. [Erev2010] Erev, I., Ert, E., Roth, A. E., Haruvy, E., Herzog, S. M., Hau, R., et al. (2010). A choice prediction competition: Choices from experience and from description. Journal of Behavioral Decision Making, 23(1), 15-47. http://doi.org/10.1002/bdm.683
    .. [Hertwig2004] Hertwig, R., Barron, G., Weber, E. U., & Erev, I. (2004). Decisions From Experience and the Effect of Rare Events in Risky Choice. Psychological Science, 15(8), 534-539. http://doi.org/10.1111/j.0956-7976.2004.00715.x
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the 2-Armed Bandit Task, there should be 3 columns of data
